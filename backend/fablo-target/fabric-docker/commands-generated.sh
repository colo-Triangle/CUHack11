...
installChannels() {
  ...
  docker exec -i cli.doctor.healthcare.com bash -c "source scripts/channel_fns.sh; createChannelAndJoin 'health-channel' 'DoctorMSP' 'peer0.doctor.healthcare.com:7041' 'crypto/users/Admin@doctor.healthcare.com/msp' 'orderer0.group1.orderer.healthcare.com:7030';"

  printItalics "Joining 'health-channel' on Patient/peer0" "U1F638"
  docker exec -i cli.patient.healthcare.com bash -c "source scripts/channel_fns.sh; fetchChannelAndJoin 'health-channel' 'PatientMSP' 'peer0.patient.healthcare.com:7061' 'crypto/users/Admin@patient.healthcare.com/msp' 'orderer0.group1.orderer.healthcare.com:7030';"
}
...
installChaincodes() {
  if [ -n "$(ls "$CHAINCODES_BASE_DIR/./chaincodes/patient")" ]; then
    ...
    chaincodeApprove "cli.doctor.healthcare.com" "peer0.doctor.healthcare.com:7041" "health-channel" "patientcc" "$version" "orderer0.group1.orderer.healthcare.com:7030" "OR('DoctorMSP.member', 'PatientMSP.member')" "false" "" ""
    ...
    chaincodeApprove "cli.patient.healthcare.com" "peer0.patient.healthcare.com:7061" "health-channel" "patientcc" "$version" "orderer0.group1.orderer.healthcare.com:7030" "OR('DoctorMSP.member', 'PatientMSP.member')" "false" "" ""
    printItalics "Committing chaincode 'patientcc' on channel 'health-channel' as 'Doctor'" "U1F618"
    chaincodeCommit "cli.doctor.healthcare.com" "peer0.doctor.healthcare.com:7041" "health-channel" "patientcc" "$version" "orderer0.group1.orderer.healthcare.com:7030" "OR('DoctorMSP.member', 'PatientMSP.member')" "false" "" "peer0.doctor.healthcare.com:7041,peer0.patient.healthcare.com:7061" "" ""
  else
...
runDevModeChaincode() {
  ...
  if [ "$chaincodeName" = "patientcc" ]; then
    ...
    chaincodeApprove "cli.doctor.healthcare.com" "peer0.doctor.healthcare.com:7041" "health-channel" "patientcc" "1.0" "orderer0.group1.orderer.healthcare.com:7030" "OR('DoctorMSP.member', 'PatientMSP.member')" "false" "" ""
    printHeadline "Approving 'patientcc' for Patient (dev mode)" "U1F60E"
    chaincodeApprove "cli.patient.healthcare.com" "peer0.patient.healthcare.com:7061" "health-channel" "patientcc" "1.0" "orderer0.group1.orderer.healthcare.com:7030" "OR('DoctorMSP.member', 'PatientMSP.member')" "false" "" ""
    printItalics "Committing chaincode 'patientcc' on channel 'health-channel' as 'Doctor' (dev mode)" "U1F618"
    chaincodeCommit "cli.doctor.healthcare.com" "peer0.doctor.healthcare.com:7041" "health-channel" "patientcc" "1.0" "orderer0.group1.orderer.healthcare.com:7030" "OR('DoctorMSP.member', 'PatientMSP.member')" "false" "" "peer0.doctor.healthcare.com:7041,peer0.patient.healthcare.com:7061" "" ""
...
notifyOrgsAboutChannels() {
  ...
  notifyOrgAboutNewChannel "health-channel" "DoctorMSP" "cli.doctor.healthcare.com" "peer0.doctor.healthcare.com" "orderer0.group1.orderer.healthcare.com:7030"
  notifyOrgAboutNewChannel "health-channel" "PatientMSP" "cli.patient.healthcare.com" "peer0.patient.healthcare.com" "orderer0.group1.orderer.healthcare.com:7030"
